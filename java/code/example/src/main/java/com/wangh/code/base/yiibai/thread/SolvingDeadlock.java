package com.wangh.code.base.yiibai.thread;
...
public class SolvingDeadlock extends ReentrantLock {
    private static List<SolvingDeadlock> deadlockLocksRegistry = new ArrayList<SolvingDeadlock>();
    ...
    private static Iterator<SolvingDeadlock> getAllLocksOwned(Thread t) {
        SolvingDeadlock current;
        List<SolvingDeadlock> results = new ArrayList<SolvingDeadlock>();
        Iterator<SolvingDeadlock> itr = deadlockLocksRegistry.iterator();
